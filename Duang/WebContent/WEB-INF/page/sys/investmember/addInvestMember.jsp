	  	...
	  	<form id="investMemberSaveForm" method="post"> 
		    ...
		    <div>   
		        <label for="bankCard" class="from_label">绑定银行卡号：</label>   
		       	<input class="easyui-validatebox" type="text" name="bankCard"/>
		    </div>
		    <div>   
		        <label for="bank" class="from_label">所属银行：</label>   
		       	<input class="easyui-validatebox" type="text" name="bank"/>
		    </div> 
		    
		    <div>   
		        <label for="bank" class="from_label">投资金额：</label>   
		       	<input class="easyui-validatebox" type="text" name="bank"/>
		    </div> 
		     <div>   
		        <label for="investMoney" class="from_label">投资金额：</label>   
		       	<input class="easyui-validatebox" type="text" name="investMoney"/>
		    </div>
		     <div>   
		        <label for="investingMoney" class="from_label">投资中金额：</label>   
		       	<input class="easyui-validatebox" type="text" name="investingMoney"/>
		    </div>
		     <div>   
		        <label for="useableMoney" class="from_label">可用余额：</label>   
		       	<input class="easyui-validatebox" type="text" name="useableMoney"/>
		    </div>
		     <div>   
		        <label for="accountTotalMoney" class="from_label">账面总余额：</label>   
		       	<input class="easyui-validatebox" type="text" name="accountTotalMoney"/>
		    </div>
		     <div>   
		        <label for="freezeMoney" class="from_label">冻结余额：</label>   
		       	<input class="easyui-validatebox" type="text" name="freezeMoney"/>
		    </div>
		     <div>   
		        <label for="unfreezeMoney" class="from_label">未冻结余额：</label>   
		       	<input class="easyui-validatebox" type="text" name="unfreezeMoney"/>
		    </div>
		     <div>   
		        <label for="useableScore" class="from_label">可用积分：</label>   
		       	<input class="easyui-validatebox" type="text" name="useableScore"/>
		    </div>
		    <div>   
		        <label for="useableScore" class="from_label">允许上线：</label>   
		       	<select  class="easyui-combobox" name="useableScore">   
		    ...
		    <div>   
		        <label for="custManagerId" class="from_label">客户经理ID：</label>   
		       	<input class="easyui-validatebox" type="text" name="custManagerId"/>
		    </div>
		    <div>   
		        <label for="managerName" class="from_label">客户经理姓名：</label>   
		       	<input class="easyui-validatebox" type="text" name="managerName"/>
		    </div>
		    <div>   
		        <label for="userImage" class="from_label">头像：</label>   
		       	<input class="easyui-filebox" name="userImage">
		    </div> 
		    <div>   
		        <label for="idcardImg1" class="from_label">身份证前照：</label>   
		       	<input class="easyui-filebox" name="idcardImg1">
		    </div>
		    <div>   
		        <label for="idcardImg2" class="from_label">身份证后照：</label>   
		       	<input class="easyui-filebox" name="idcardImg2">
		    </div> 
		</form>  
	</div>
