...
/**
 * 借贷基数
 * @ClassName:  LoanListRateServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年12月20日 上午11:28:47
 */
@ServiceLog(ModelName="基数")
@Service(value="loanlistrateserviceimpl")
public class LoanListRateServiceImpl implements LoanListRateService{

	private LoanListRateDao dao;

	@Resource(name="loanlistratedaoimpl")
	public void setDao(LoanListRateDao dao) {
		this.dao = dao;
	}
	public LoanListRateServiceImpl(){
		LoggerUtils.info("注入LoanListRateServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<LoanListRate> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<LoanListRate> queryAllEntity(PageUtil<LoanListRate> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<LoanListRate> queryEntity(String field, Object value, PageUtil<LoanListRate> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<LoanListRate> queryEntity(List<String> properties, List<Object> values, PageUtil<LoanListRate> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public LoanListRate findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(LoanListRate t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(LoanListRate t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public LoanListRate findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public LoanListRate findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<LoanListRate> queryByHQL(String hql,String counthql, PageUtil<LoanListRate> page, Object... params) throws Exception{
	...
	@Override
	public boolean deleteEntity(LoanListRate t) throws Exception {
		return dao.deleteEntity(t);
	}
	@Override
