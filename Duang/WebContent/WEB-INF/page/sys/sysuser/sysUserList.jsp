...
<body>
	    <table id="sysUserToolbar" style="width:100%" >
	    	<tr style="float: left">
				<td >
		    	  <a href="javascript:void();" onclick="openAddSysUserView();" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加用户</a>
				</td>	
			</tr>
		 </table>   
...
<script type="text/javascript" src="<%=request.getContextPath() %>/ui/system/sysUserList.js"></script>
