 ...
 */  
@ServiceLog(ModelName="客户经理管理")
@Service(value="customermanagerserviceimpl")
public class CustomerManagerServiceImpl implements CustomerManagerService{

	private CustomerManagerDao dao;

	@Resource(name="customermanagerdaoimpl")
	public void setDao(CustomerManagerDao dao) {
		this.dao = dao;
	}

	public CustomerManagerServiceImpl(){
		LoggerUtils.info("注入CustomerManagerServiceImpl服务层", this.getClass());
	}
