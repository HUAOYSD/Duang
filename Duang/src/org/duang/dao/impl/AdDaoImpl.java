 ...
 * @author LiYonghui
 * @date 2016年9月5日 下午4:29:05      
 */  
@Repository("addaoimpl")
public class AdDaoImpl extends BaseDao<Ad> implements AdDao{


	public AdDaoImpl(){
		LoggerUtils.info("注入AdDaoImpl层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Ad> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Ad> queryAllEntity(PageUtil<Ad> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Ad> queryEntity(String field, Object value, PageUtil<Ad> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Ad> queryEntity(List<String> properties, List<Object> values, PageUtil<Ad> page) throws Exception{
		DetachedCriteria detachedCriteria = super.fillDtCriteria(properties, values);
	 ...
	 * @return   返回的类对象
	 */
	public Ad findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(Ad t) throws Exception{
		super.save(t);
		return true;
	}
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(Ad t) throws Exception{
		super.update(t);
		return true;
	}
	 ...
	 * @return   是否删除成功
	 */
	public boolean deleteEntity(Ad t) throws Exception{
		super.delete(t);
		return true;
	}
	 ...
	 * @throws Exception
	 */
	public Ad findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public Ad findEntity(Map<String, Object> params) throws Exception{
