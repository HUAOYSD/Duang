...
import org.duang.dao.RequestFlowDao;
...
/**
 * 请求流水业务层实现类
 * @ClassName:  RequestFlowServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月13日 下午 16:31:52
 */
@ServiceLog(ModelName="请求流水")
@Service(value="requestflowserviceimpl")
public class RequestFlowServiceImpl implements RequestFlowService{

	private RequestFlowDao dao;

	@Resource(name="requestflowdaoimpl")
	public void setDao(RequestFlowDao dao) {
		this.dao = dao;
	}

	public RequestFlowServiceImpl(){
		LoggerUtils.info("注入RequestFlowServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<RequestFlow> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<RequestFlow> queryAllEntity(PageUtil<RequestFlow> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<RequestFlow> queryEntity(String field, Object value, PageUtil<RequestFlow> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<RequestFlow> queryEntity(List<String> properties, List<Object> values, PageUtil<RequestFlow> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public RequestFlow findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(RequestFlow t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(RequestFlow t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public RequestFlow findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public RequestFlow findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<RequestFlow> queryByHQL(String hql,String counthql, PageUtil<RequestFlow> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<RequestFlow> queryBySQL(String sql,String countsql, PageUtil<RequestFlow> page, boolean convert, Object... params) throws Exception{
