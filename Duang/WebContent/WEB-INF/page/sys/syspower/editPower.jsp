...
<body style="background-color:#fff;">
	<div class="operate_div_form">
	  	<form id="power_edit_form" method="post"> 
	...
	<div align="center" class="footer-oper">
   	    <div class="content-oper">
	    	 <a id="power_edit_form_submitbtn" class="easyui-linkbutton my-search-button" data-options="iconCls:'icon-2012092109942'" plain="true">保存</a>
		     &nbsp;&nbsp;&nbsp;&nbsp;
		     <a onclick="javascript:$('#power_edit_form').form('reset');" class="easyui-linkbutton my-search-button" iconCls="icon-reset" plain="true" >重置</a>
    	</div>
	</div>  
