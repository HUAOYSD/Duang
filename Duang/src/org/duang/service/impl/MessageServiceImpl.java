 ...
 * @author LiYonghui
 * @date 2016年8月18日 上午11:19:42
 */
@ServiceLog(ModelName="消息")
...
public class MessageServiceImpl implements MessageService{
	...
	public MessageServiceImpl(){
		LoggerUtils.info("注入MessageServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Message> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Message> queryAllEntity(PageUtil<Message> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Message> queryEntity(String field, Object value, PageUtil<Message> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Message> queryEntity(List<String> properties, List<Object> values, PageUtil<Message> page) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(Message t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(Message t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public Message findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public Message findEntity(Map<String, Object> params) throws Exception{
	...
	@Override
	public boolean deleteEntity(Message t) throws Exception {
		return dao.deleteEntity(t);
	}
}
