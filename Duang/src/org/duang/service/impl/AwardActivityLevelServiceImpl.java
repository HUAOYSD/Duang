...
import org.duang.dao.AwardActivityLevelDao;
...
/**
 * 奖品等级业务处理类
 * @ClassName:  AwardActivityLevelServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月14日 下午4:28:44
 */
@ServiceLog(ModelName="奖品级别")
@Service(value="awardactivitylevelserviceimpl")
public class AwardActivityLevelServiceImpl implements AwardActivityLevelService{

	private AwardActivityLevelDao dao;

	@Resource(name="awardactivityleveldaoimpl")
	public void setDao(AwardActivityLevelDao dao) {
		this.dao = dao;
	}

	public AwardActivityLevelServiceImpl(){
		LoggerUtils.info("注入AwardActivityLevelServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<AwardActivityLevel> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<AwardActivityLevel> queryAllEntity(PageUtil<AwardActivityLevel> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<AwardActivityLevel> queryEntity(String field, Object value, PageUtil<AwardActivityLevel> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<AwardActivityLevel> queryEntity(List<String> properties, List<Object> values, PageUtil<AwardActivityLevel> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public AwardActivityLevel findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(AwardActivityLevel t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(AwardActivityLevel t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public AwardActivityLevel findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public AwardActivityLevel findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<AwardActivityLevel> queryByHQL(String hql,String counthql, PageUtil<AwardActivityLevel> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<AwardActivityLevel> queryBySQL(String sql,String countsql, PageUtil<AwardActivityLevel> page, boolean convert, Object... params) throws Exception{
		return dao.queryBySQL(sql, countsql, page, convert, params);
	}

	@Override
	public boolean deleteEntity(AwardActivityLevel t) throws Exception {
		return dao.deleteEntity(t);
	}
}
