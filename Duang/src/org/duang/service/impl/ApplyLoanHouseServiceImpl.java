...
import org.duang.dao.ApplyLoanHouseDao;
...
/**
 * 房产贷款信息业务层实现类
 * @ClassName:  ApplyLoanHouseServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月22日 上午10:31:52
 */
@ServiceLog(ModelName="房产贷款")
@Service(value="applyloanhouseserviceimpl")
public class ApplyLoanHouseServiceImpl implements ApplyLoanHouseService{

	private ApplyLoanHouseDao dao;

	@Resource(name="applyloanhousedaoimpl")
	public void setDao(ApplyLoanHouseDao dao) {
		this.dao = dao;
	}

	public ApplyLoanHouseServiceImpl(){
		LoggerUtils.info("注入ApplyLoanHouseServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<ApplyLoanHouse> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<ApplyLoanHouse> queryAllEntity(PageUtil<ApplyLoanHouse> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<ApplyLoanHouse> queryEntity(String field, Object value, PageUtil<ApplyLoanHouse> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<ApplyLoanHouse> queryEntity(List<String> properties, List<Object> values, PageUtil<ApplyLoanHouse> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public ApplyLoanHouse findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(ApplyLoanHouse t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(ApplyLoanHouse t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public ApplyLoanHouse findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public ApplyLoanHouse findEntity(Map<String, Object> params) throws Exception{
