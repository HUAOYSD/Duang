...
/**
 * 借贷基数
 * @ClassName:  LoanListRateDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年12月20日 上午10:29:23
 */
@Repository("loanlistratedaoimpl")
public class LoanListRateDaoImpl extends BaseDao<LoanListRate> implements LoanListRateDao{


	public LoanListRateDaoImpl(){
		LoggerUtils.info("注入LoanListRateDaoImpl层", this.getClass());
	}
