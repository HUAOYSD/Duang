...
<body style="background-color:#fff;">
	<div class="operate_div_form">
	  	<form id="ad_add_form" method="post"> 
	  		<div>   
	...
	<div align="center" class="footer-oper">
   	    <div class="content-oper">
	    	 <a id="ad_add_form_submitbtn" class="easyui-linkbutton my-search-button" data-options="iconCls:'icon-2012092109942'" plain="true">保存</a>
		     &nbsp;&nbsp;&nbsp;&nbsp;
		     <a onclick="javascript:$('#ad_add_form').form('reset');" class="easyui-linkbutton my-search-button" iconCls="icon-reset" plain="true" >重置</a>
    	</div>
	</div>  
