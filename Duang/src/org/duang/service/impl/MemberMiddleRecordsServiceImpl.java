...
/**
 * 居间人放款Service层
 * @ClassName:  MemberMiddleRecordsServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年12月5日 上午11:34:37
 */
@ServiceLog(ModelName="居间人放款")
@Service(value="membermiddlerecordsserviceimpl")
public class MemberMiddleRecordsServiceImpl implements MemberMiddleRecordsService{
	...
	public MemberMiddleRecordsServiceImpl(){
		LoggerUtils.info("注入MemberMiddleRecordsServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberMiddleRecords> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberMiddleRecords> queryAllEntity(PageUtil<MemberMiddleRecords> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberMiddleRecords> queryEntity(String field, Object value, PageUtil<MemberMiddleRecords> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberMiddleRecords> queryEntity(List<String> properties, List<Object> values, PageUtil<MemberMiddleRecords> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public MemberMiddleRecords findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(MemberMiddleRecords t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(MemberMiddleRecords t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public MemberMiddleRecords findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public MemberMiddleRecords findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<MemberMiddleRecords> queryByHQL(String hql,String counthql, PageUtil<MemberMiddleRecords> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<MemberMiddleRecords> queryBySQL(String sql,String countsql, PageUtil<MemberMiddleRecords> page, boolean convert, Object... params) throws Exception{
		return dao.queryBySQL(sql, countsql, page, convert, params);
	}

	@Override
	public boolean deleteEntity(MemberMiddleRecords t) throws Exception {
		return dao.deleteEntity(t);
	}
}
