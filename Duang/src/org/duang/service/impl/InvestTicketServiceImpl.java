...
import org.duang.dao.InvestTicketDao;
...
/**   
 * 理财券接口实现类
 * @ClassName:  InvestTicketServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月16日 下午5:19:26      
 */  
@ServiceLog(ModelName="理财券")
@Service(value="investticketserviceimpl")
public class InvestTicketServiceImpl implements InvestTicketService{

	private InvestTicketDao dao;

	@Resource(name="investticketdaoimpl")
	public void setDao(InvestTicketDao dao) {
		this.dao = dao;
	}

	public InvestTicketServiceImpl(){
		LoggerUtils.info("注入InvestTicketServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<InvestTicket> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<InvestTicket> queryAllEntity(PageUtil<InvestTicket> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<InvestTicket> queryEntity(String field, Object value, PageUtil<InvestTicket> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<InvestTicket> queryEntity(List<String> properties, List<Object> values, PageUtil<InvestTicket> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public InvestTicket findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(InvestTicket t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(InvestTicket t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public InvestTicket findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public InvestTicket findEntity(Map<String, Object> params) throws Exception{
