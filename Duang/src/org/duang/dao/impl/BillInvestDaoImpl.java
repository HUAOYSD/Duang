...
/**   
 * 理财资金记录 dao实现类
 * @ClassName:  BillInvestDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月23日 下午4:29:05      
 */  
@Repository("billinvestdaoimpl")
public class BillInvestDaoImpl extends BaseDao<BillInvest> implements BillInvestDao{


	public BillInvestDaoImpl(){
		LoggerUtils.info("注入BillInvestDaoImpl层", this.getClass());
	}
