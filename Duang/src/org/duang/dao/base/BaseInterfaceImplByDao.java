...
/** 
 * 为Dao类统一实现BaseInterface
 * @ClassName: BaseInterfaceImplByDao 
 * @Description: TODO 
 * @author 白攀 
 * @date 2016-2-29 下午3:34:45 
 */
public class BaseInterfaceImplByDao<M> extends BaseDaoImpl<M> {
	
	public BaseInterfaceImplByDao(){
		System.out.println("注入：为Dao类统一实现BaseInterface");
	}
