...
/**
 * 急速贷款信息业务层实现类
 * @ClassName:  ApplyLoanFastServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年12月22日 上午10:31:52
 */
@ServiceLog(ModelName="车产贷款")
@Service(value="applyloanfastserviceimpl")
public class ApplyLoanFastServiceImpl implements ApplyLoanFastService{

	private ApplyLoanFastDao dao;

	@Resource(name="applyloanfastdaoimpl")
	public void setDao(ApplyLoanFastDao dao) {
		this.dao = dao;
	}
	...
	public ApplyLoanFastServiceImpl(){
		LoggerUtils.info("注入ApplyLoanFastServiceImpl服务层", this.getClass());
	}
