...
import org.duang.dao.AwardActivityDao;
 ...
 * 奖品等级业务处理类
 *
 * @ClassName:  AwardActivityServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月14日 下午4:29:48
 */
@ServiceLog(ModelName="奖品活动")
@Service(value="awardactivityserviceimpl")
public class AwardActivityServiceImpl implements AwardActivityService{

	private AwardActivityDao dao;

	@Resource(name="awardactivitydaoimpl")
	public void setDao(AwardActivityDao dao) {
		this.dao = dao;
	}

	public AwardActivityServiceImpl(){
		LoggerUtils.info("注入AwardActivityServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<AwardActivity> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<AwardActivity> queryAllEntity(PageUtil<AwardActivity> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<AwardActivity> queryEntity(String field, Object value, PageUtil<AwardActivity> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<AwardActivity> queryEntity(List<String> properties, List<Object> values, PageUtil<AwardActivity> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public AwardActivity findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(AwardActivity t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(AwardActivity t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public AwardActivity findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public AwardActivity findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<AwardActivity> queryByHQL(String hql,String counthql, PageUtil<AwardActivity> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<AwardActivity> queryBySQL(String sql,String countsql, PageUtil<AwardActivity> page, boolean convert, Object... params) throws Exception{
		return dao.queryBySQL(sql, countsql, page, convert, params);
	}

	@Override
	public boolean deleteEntity(AwardActivity t) throws Exception {
		return dao.deleteEntity(t);
	}
}
