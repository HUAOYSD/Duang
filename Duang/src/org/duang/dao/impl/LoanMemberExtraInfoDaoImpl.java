...
/**
 * 借款人的附加信息
 * @ClassName:  LoanMemberExtraInfoDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年12月8日 上午10:30:59
 */
@Repository("loanmemberextrainfodaoimpl")
public class LoanMemberExtraInfoDaoImpl extends BaseDao<LoanMemberExtraInfo> implements LoanMemberExtraInfoDao{


	public LoanMemberExtraInfoDaoImpl(){
		LoggerUtils.info("注入LoanMemberExtraInfoDaoImpl层", this.getClass());
	}
