...
/**
 * 房产贷款信息
 * @ClassName:  ApplyLoanHouseDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月22日 上午10:29:23
 */
@Repository("applyloanhousedaoimpl")
public class ApplyLoanHouseDaoImpl extends BaseDao<ApplyLoanHouse> implements ApplyLoanHouseDao{


	public ApplyLoanHouseDaoImpl(){
		LoggerUtils.info("注入ApplyLoanHouseDaoImpl层", this.getClass());
	}
