...
/**
 * 请求流水实现类  
 * @ClassName:  RequestFlowDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月13日 下午 4:29:23
 */
@Repository("requestflowdaoimpl")
public class RequestFlowDaoImpl extends BaseDao<RequestFlow> implements RequestFlowDao{


	public RequestFlowDaoImpl(){
		LoggerUtils.info("注入RequestFlowDaoImpl层", this.getClass());
	}
