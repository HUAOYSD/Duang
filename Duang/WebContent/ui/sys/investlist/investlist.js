...
function loadinvestlist(url, dataObj){
	$('#investlist').datagrid({
		...
		columns : [ [
		             ...
		             {field : "yetMoney", title : "已投金额", width : 100, align : "center" },
		             {field : "spaceMoney", title : "未投金额", width : 100, align : "center" },
		             {field : "useTicket", title : "使用理财券", width : 100, align : "center" },
		             {field : "expectIncome", title : "预期收益", width : 100, align : "center" },
