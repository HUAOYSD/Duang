...
/**
 * 抽奖活动
 * @ClassName:  AwardActivityDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月14日 下午4:20:10
 */
@Repository("awardactivitydaoimpl")
public class AwardActivityDaoImpl extends BaseDao<AwardActivity> implements AwardActivityDao{


	public AwardActivityDaoImpl(){
		LoggerUtils.info("注入AwardActivityDaoImpl层", this.getClass());
	}
