...
public class InvestListDaoImpl extends BaseDao<InvestList> implements InvestListDao{


	public InvestListDaoImpl(){
		LoggerUtils.info("注入InvestListDaoImpl层", this.getClass());
	}
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(InvestList t) throws Exception{
		super.save(t);
		return true;
	}
