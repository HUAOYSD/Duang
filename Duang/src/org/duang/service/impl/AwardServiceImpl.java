 ...
 * @author LiYonghui
 * @date 2016年11月14日 下午4:31:03
 */
@ServiceLog(ModelName="奖品")
@Service(value="awardserviceimpl")
public class AwardServiceImpl implements AwardService{

	private AwardDao dao;

	@Resource(name="awarddaoimpl")
	public void setDao(AwardDao dao) {
		this.dao = dao;
	}

	public AwardServiceImpl(){
		LoggerUtils.info("注入AwardServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Award> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Award> queryAllEntity(PageUtil<Award> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Award> queryEntity(String field, Object value, PageUtil<Award> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Award> queryEntity(List<String> properties, List<Object> values, PageUtil<Award> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public Award findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(Award t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(Award t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public Award findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public Award findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<Award> queryByHQL(String hql,String counthql, PageUtil<Award> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<Award> queryBySQL(String sql,String countsql, PageUtil<Award> page, boolean convert, Object... params) throws Exception{
		return dao.queryBySQL(sql, countsql, page, convert, params);
	}

	@Override
	public boolean deleteEntity(Award t) throws Exception {
		return dao.deleteEntity(t);
	}
}
