...
import org.duang.dao.ApplyLoanInfoDao;
...
/**
 * 普通和急速模式贷款的申请信息业务实现类
 * @ClassName:  ApplyLoanInfoServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月22日 上午10:31:52
 */
@ServiceLog(ModelName="普通和急速模式贷款的申请信息")
@Service(value="applyloaninfoserviceimpl")
public class ApplyLoanInfoServiceImpl implements ApplyLoanInfoService{

	private ApplyLoanInfoDao dao;

	@Resource(name="applyloaninfodaoimpl")
	public void setDao(ApplyLoanInfoDao dao) {
		this.dao = dao;
	}

	public ApplyLoanInfoServiceImpl(){
		LoggerUtils.info("注入ApplyLoanInfoServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<ApplyLoanInfo> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<ApplyLoanInfo> queryAllEntity(PageUtil<ApplyLoanInfo> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<ApplyLoanInfo> queryEntity(String field, Object value, PageUtil<ApplyLoanInfo> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<ApplyLoanInfo> queryEntity(List<String> properties, List<Object> values, PageUtil<ApplyLoanInfo> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public ApplyLoanInfo findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(ApplyLoanInfo t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(ApplyLoanInfo t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public ApplyLoanInfo findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public ApplyLoanInfo findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<ApplyLoanInfo> queryBySQL(String sql,String countsql, PageUtil<ApplyLoanInfo> page, boolean convert, Object... params) throws Exception{
	 ...
	 * @return   是否删除成功
	 */
	public boolean deleteEntity(ApplyLoanInfo t) throws Exception {
