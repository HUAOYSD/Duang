...
import org.duang.dao.NewsInformationDao;
...
/**
 * @ClassName:  NewsInformationServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年10月13日 下午4:25:33
 */
@ServiceLog(ModelName="新闻资讯")
@Service(value="newsinformationserviceimpl")
public class NewsInformationServiceImpl implements NewsInformationService{

	private NewsInformationDao dao;

	@Resource(name="newsinformationdaoimpl")
	public void setDao(NewsInformationDao dao) {
		this.dao = dao;
	}

	public NewsInformationServiceImpl(){
		LoggerUtils.info("注入NewsInformationServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<NewsInformation> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<NewsInformation> queryAllEntity(PageUtil<NewsInformation> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<NewsInformation> queryEntity(String field, Object value, PageUtil<NewsInformation> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<NewsInformation> queryEntity(List<String> properties, List<Object> values, PageUtil<NewsInformation> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public NewsInformation findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(NewsInformation t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(NewsInformation t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public NewsInformation findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public NewsInformation findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<NewsInformation> queryByHQL(String hql,String counthql, PageUtil<NewsInformation> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<NewsInformation> queryBySQL(String sql,String countsql, PageUtil<NewsInformation> page, boolean convert, Object... params) throws Exception{
		return dao.queryBySQL(sql, countsql, page, convert, params);
	}

	@Override
	public boolean deleteEntity(NewsInformation t) throws Exception {
		return dao.deleteEntity(t);
	}
}
