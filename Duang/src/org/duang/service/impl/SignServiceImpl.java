 ...
 * @author LiYonghui
 * @date 2016年10月21日 上午9:54:19
 */
@ServiceLog(ModelName="签到")
...
public class SignServiceImpl implements SignService{
	...
	public SignServiceImpl(){
		LoggerUtils.info("注入SignServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Sign> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Sign> queryAllEntity(PageUtil<Sign> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Sign> queryEntity(String field, Object value, PageUtil<Sign> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<Sign> queryEntity(List<String> properties, List<Object> values, PageUtil<Sign> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public Sign findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(Sign t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(Sign t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public Sign findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public Sign findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<Sign> queryByHQL(String hql,String counthql, PageUtil<Sign> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<Sign> queryBySQL(String sql,String countsql, PageUtil<Sign> page, boolean convert, Object... params) throws Exception{
		return dao.queryBySQL(sql, countsql, page, convert, params);
	}

	@Override
	public boolean deleteEntity(Sign t) throws Exception {
		return dao.deleteEntity(t);
	}
}
