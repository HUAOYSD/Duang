...
/**
 * 用户中奖记录
 * @ClassName:  MemberAwardDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月15日 上午10:30:19
 */
@Repository("memberawarddaoimpl")
public class MemberAwardDaoImpl extends BaseDao<MemberAward> implements MemberAwardDao{


	public MemberAwardDaoImpl(){
		LoggerUtils.info("注入MemberAwardDaoImpl层", this.getClass());
	}
