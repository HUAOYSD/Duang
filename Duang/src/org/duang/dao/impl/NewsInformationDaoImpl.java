...
/**
 * 新闻资讯
 * @ClassName:  NewsInformationDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年10月13日 下午4:18:25
 */
@Repository("newsinformationdaoimpl")
public class NewsInformationDaoImpl extends BaseDao<NewsInformation> implements NewsInformationDao{


	public NewsInformationDaoImpl(){
		LoggerUtils.info("注入NewsInformationDaoImpl层", this.getClass());
	}
