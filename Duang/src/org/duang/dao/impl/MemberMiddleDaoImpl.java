...
/**
 * 中间人Dao实现层
 * @ClassName:  MemberMiddleDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月28日 上午9:50:02
 */
@Repository("membermiddledaoimpl")
public class MemberMiddleDaoImpl extends BaseDao<MemberMiddle> implements MemberMiddleDao{


	public MemberMiddleDaoImpl(){
		LoggerUtils.info("注入MemberMiddleDaoImpl层", this.getClass());
	}
