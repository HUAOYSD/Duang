...
import org.duang.dao.MemberAwardDao;
...
/**
 * 用户中奖记录
 * @ClassName:  MemberAwardServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月15日 上午10:32:59
 */
@ServiceLog(ModelName="用户中奖记录")
@Service(value="memberawardserviceimpl")
public class MemberAwardServiceImpl implements MemberAwardService{

	private MemberAwardDao dao;

	@Resource(name="memberawarddaoimpl")
	public void setDao(MemberAwardDao dao) {
		this.dao = dao;
	}

	public MemberAwardServiceImpl(){
		LoggerUtils.info("注入MemberAwardServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberAward> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberAward> queryAllEntity(PageUtil<MemberAward> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberAward> queryEntity(String field, Object value, PageUtil<MemberAward> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberAward> queryEntity(List<String> properties, List<Object> values, PageUtil<MemberAward> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public MemberAward findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(MemberAward t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(MemberAward t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public MemberAward findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public MemberAward findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<MemberAward> queryByHQL(String hql,String counthql, PageUtil<MemberAward> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<MemberAward> queryBySQL(String sql,String countsql, PageUtil<MemberAward> page, boolean convert, Object... params) throws Exception{
		return dao.queryBySQL(sql, countsql, page, convert, params);
	}

	@Override
	public boolean deleteEntity(MemberAward t) throws Exception {
		return dao.deleteEntity(t);
	}
}
