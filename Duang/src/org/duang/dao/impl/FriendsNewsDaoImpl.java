...
/**
 * 财友动态
 * @ClassName:  FriendsNewsDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年10月13日 下午5:15:17
 */
@Repository("friendsnewsdaoimpl")
public class FriendsNewsDaoImpl extends BaseDao<FriendsNews> implements FriendsNewsDao{


	public FriendsNewsDaoImpl(){
		LoggerUtils.info("注入FriendsNewsDaoImpl层", this.getClass());
	}
