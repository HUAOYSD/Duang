...
/**
 * 中间人Service实现类
 * @ClassName:  MemberMiddleServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月28日 上午9:58:15
 */
@ServiceLog(ModelName="中间人")
@Service(value="membermiddleserviceimpl")
public class MemberMiddleServiceImpl implements MemberMiddleService{

	private MemberMiddleDao dao;

	@Resource(name="membermiddledaoimpl")
	public void setDao(MemberMiddleDao dao) {
		this.dao = dao;
	}

	public MemberMiddleServiceImpl(){
		LoggerUtils.info("注入MemberMiddleServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberMiddle> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberMiddle> queryAllEntity(PageUtil<MemberMiddle> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberMiddle> queryEntity(String field, Object value, PageUtil<MemberMiddle> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<MemberMiddle> queryEntity(List<String> properties, List<Object> values, PageUtil<MemberMiddle> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public MemberMiddle findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(MemberMiddle t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(MemberMiddle t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public MemberMiddle findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public MemberMiddle findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<MemberMiddle> queryByHQL(String hql,String counthql, PageUtil<MemberMiddle> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<MemberMiddle> queryBySQL(String sql,String countsql, PageUtil<MemberMiddle> page, boolean convert, Object... params) throws Exception{
		return dao.queryBySQL(sql, countsql, page, convert, params);
	}

	@Override
	public boolean deleteEntity(MemberMiddle t) throws Exception {
		return dao.deleteEntity(t);
	}
}
