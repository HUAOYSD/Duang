...
/**
 * 奖品等级
 * @ClassName:  AwardActivityLevelDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年11月14日 下午4:21:04
 */
@Repository("awardactivityleveldaoimpl")
public class AwardActivityLevelDaoImpl extends BaseDao<AwardActivityLevel> implements AwardActivityLevelDao{


	public AwardActivityLevelDaoImpl(){
		LoggerUtils.info("注入AwardActivityLevelDaoImpl层", this.getClass());
	}
