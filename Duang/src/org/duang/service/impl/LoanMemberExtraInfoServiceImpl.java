...
import org.duang.dao.LoanMemberExtraInfoDao;
...
/**
 * 借款人的附加信息
 * @ClassName:  LoanMemberExtraInfoServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年12月8日 上午10:31:52
 */
@ServiceLog(ModelName="借贷人附加信息")
@Service(value="loanmemberextrainfoserviceimpl")
public class LoanMemberExtraInfoServiceImpl implements LoanMemberExtraInfoService{

	private LoanMemberExtraInfoDao dao;

	@Resource(name="loanmemberextrainfodaoimpl")
	public void setDao(LoanMemberExtraInfoDao dao) {
		this.dao = dao;
	}

	public LoanMemberExtraInfoServiceImpl(){
		LoggerUtils.info("注入LoanMemberExtraInfoServiceImpl服务层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<LoanMemberExtraInfo> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<LoanMemberExtraInfo> queryAllEntity(PageUtil<LoanMemberExtraInfo> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<LoanMemberExtraInfo> queryEntity(String field, Object value, PageUtil<LoanMemberExtraInfo> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<LoanMemberExtraInfo> queryEntity(List<String> properties, List<Object> values, PageUtil<LoanMemberExtraInfo> page) throws Exception{
	 ...
	 * @return   返回的类对象
	 */
	public LoanMemberExtraInfo findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(LoanMemberExtraInfo t) throws Exception{
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(LoanMemberExtraInfo t) throws Exception{
	 ...
	 * @throws Exception
	 */
	public LoanMemberExtraInfo findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public LoanMemberExtraInfo findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<LoanMemberExtraInfo> queryByHQL(String hql,String counthql, PageUtil<LoanMemberExtraInfo> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<LoanMemberExtraInfo> queryBySQL(String sql,String countsql, PageUtil<LoanMemberExtraInfo> page, boolean convert, Object... params) throws Exception{
		return dao.queryBySQL(sql, countsql, page, convert, params);
	}

	@Override
	public boolean deleteEntity(LoanMemberExtraInfo t) throws Exception {
		return dao.deleteEntity(t);
	}
}
