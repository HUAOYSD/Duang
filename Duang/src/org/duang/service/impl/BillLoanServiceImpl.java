...
/**   
 * 投资者资金放款还款记录业务接口实现类
 * @ClassName:  BillLoanServiceImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月23日 下午2:19:26      
 */  
@ServiceLog(ModelName="投资者资金放款还款记录")
@Service(value="billloanserviceimpl")
public class BillLoanServiceImpl implements BillLoanService{

	private BillLoanDao dao;

	@Resource(name="billloandaoimpl")
	public void setDao(BillLoanDao dao) {
		this.dao = dao;
	}

	public BillLoanServiceImpl(){
		LoggerUtils.info("注入BillLoanServiceImpl服务层", this.getClass());
	}
	 ...
	 * @throws Exception
	 */
	public List<BillLoan> queryBySQL(String sql,String countsql, PageUtil<BillLoan> page, boolean convert, Object... params) throws Exception{
