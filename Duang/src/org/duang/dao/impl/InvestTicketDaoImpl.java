...
/**   
 * 理财券dao实现类
 * @ClassName:  InvestTicketDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月16日 下午4:29:05      
 */  
@Repository("investticketdaoimpl")
public class InvestTicketDaoImpl extends BaseDao<InvestTicket> implements InvestTicketDao{


	public InvestTicketDaoImpl(){
		LoggerUtils.info("注入InvestTicketDaoImpl层", this.getClass());
	}
