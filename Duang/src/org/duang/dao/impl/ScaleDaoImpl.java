...
/**   
 * 标dao实现类
 * @ClassName:  ScaleDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月8日 下午3:23:04      
 */  
@Repository("scaledaoimpl")
public class ScaleDaoImpl extends BaseDao<Scale> implements ScaleDao{


	public ScaleDaoImpl(){
		LoggerUtils.info("注入ScaleDaoImpl层", this.getClass());
	}
