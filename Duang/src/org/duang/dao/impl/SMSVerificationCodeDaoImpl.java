...
/**
 * 短信验证码
 * @ClassName:  SMSVerificationCodeDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年10月24日 下午4:39:59
 */
@Repository("smsverificationcodedaoimpl")
public class SMSVerificationCodeDaoImpl extends BaseDao<SMSVerificationCode> implements SMSVerificationCodeDao{


	public SMSVerificationCodeDaoImpl(){
		LoggerUtils.info("注入SMSVerificationCodeDaoImpl层", this.getClass());
	}
