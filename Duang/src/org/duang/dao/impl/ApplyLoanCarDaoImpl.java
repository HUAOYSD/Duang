...
/**
 * 车产贷款信息实现类  
 * @ClassName:  ApplyLoanCarDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月22日 上午10:29:23
 */
@Repository("applyloancardaoimpl")
public class ApplyLoanCarDaoImpl extends BaseDao<ApplyLoanCar> implements ApplyLoanCarDao{


	public ApplyLoanCarDaoImpl(){
		LoggerUtils.info("注入ApplyLoanCarDaoImpl层", this.getClass());
	}
