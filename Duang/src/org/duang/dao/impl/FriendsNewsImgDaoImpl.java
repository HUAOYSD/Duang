...
/**
 * 财友动态图片
 * @ClassName:  FriendsNewsImgDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年10月14日 上午10:04:54
 */
@Repository("friendsnewsimgdaoimpl")
public class FriendsNewsImgDaoImpl extends BaseDao<FriendsNewsImg> implements FriendsNewsImgDao{


	public FriendsNewsImgDaoImpl(){
		LoggerUtils.info("注入FriendsNewsImgDaoImpl层", this.getClass());
	}
