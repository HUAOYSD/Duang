...
/**
 * 居间人放宽Dao
 * @ClassName:  MemberMiddleRecordsDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年12月5日 上午11:32:28
 */
@Repository("membermiddlerecordsdaoimpl")
public class MemberMiddleRecordsDaoImpl extends BaseDao<MemberMiddleRecords> implements MemberMiddleRecordsDao{


	public MemberMiddleRecordsDaoImpl(){
		LoggerUtils.info("注入MemberMiddleRecordsDaoImpl层", this.getClass());
	}
