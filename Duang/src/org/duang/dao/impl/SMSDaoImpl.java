 ...
 * @author LiYonghui
 * @date 2016年9月19日 上午10:29:23
 */
@Repository("smsdaoimpl")
public class SMSDaoImpl extends BaseDao<SMS> implements SMSDao{


	public SMSDaoImpl(){
		LoggerUtils.info("注入SMSDaoImpl层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<SMS> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<SMS> queryAllEntity(PageUtil<SMS> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<SMS> queryEntity(String field, Object value, PageUtil<SMS> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<SMS> queryEntity(List<String> properties, List<Object> values, PageUtil<SMS> page) throws Exception{
		DetachedCriteria detachedCriteria = super.fillDtCriteria(properties, values);
	 ...
	 * @return   返回的类对象
	 */
	public SMS findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(SMS t) throws Exception{
		super.save(t);
		return true;
	}
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(SMS t) throws Exception{
		super.update(t);
		return true;
	}
	 ...
	 * @return   是否删除成功
	 */
	public boolean deleteEntity(SMS t) throws Exception{
		super.delete(t);
		return true;
	}
	 ...
	 * @throws Exception
	 */
	public SMS findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public SMS findEntity(Map<String, Object> params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<SMS> queryByHQL(String hql, String countHql, PageUtil<SMS> page, Object... params) throws Exception{
	 ...
	 * @throws Exception
	 */
	public List<SMS> queryBySQL(String sql, String countSql, PageUtil<SMS> page, boolean convert, Object... params) throws Exception{
