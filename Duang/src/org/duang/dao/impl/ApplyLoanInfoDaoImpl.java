...
/**
 * 普通和急速模式贷款的申请信息  
 * @ClassName:  ApplyLoanInfoDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月22日 上午10:29:23
 */
@Repository("applyloaninfodaoimpl")
public class ApplyLoanInfoDaoImpl extends BaseDao<ApplyLoanInfo> implements ApplyLoanInfoDao{


	public ApplyLoanInfoDaoImpl(){
