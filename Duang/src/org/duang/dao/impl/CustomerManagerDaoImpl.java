...
import org.duang.dao.CustomerManagerDao;
...
/**   
 * 客户经理dao实现类
 * @ClassName:  CustomerManagerDaoImpl   
 * @Description:TODO(这里用一句话描述这个类的作用)   
 * @author LiYonghui
 * @date 2016年8月8日 下午3:23:04      
 */  
@Repository("customermanagerdaoimpl")
public class CustomerManagerDaoImpl extends BaseDao<CustomerManager> implements CustomerManagerDao{


	public CustomerManagerDaoImpl(){
		LoggerUtils.info("注入CustomerManagerDaoImpl层", this.getClass());
	}
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<CustomerManager> queryAllEntity(Order order) throws Exception {
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<CustomerManager> queryAllEntity(PageUtil<CustomerManager> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<CustomerManager> queryEntity(String field, Object value, PageUtil<CustomerManager> page, Order order) throws Exception{
	 ...
	 * @return 			    返回操作实体类的泛型集合
	 */
	public List<CustomerManager> queryEntity(List<String> properties, List<Object> values, PageUtil<CustomerManager> page) throws Exception{
		DetachedCriteria detachedCriteria = super.fillDtCriteria(properties, values);
	 ...
	 * @return   返回的类对象
	 */
	public CustomerManager findById(Serializable id) throws Exception{
	 ...
	 * @return   是否增加成功
	 */
	public boolean saveEntity(CustomerManager t) throws Exception{
		super.save(t);
		return true;
	}
	 ...
	 * @return   是否修改成功
	 */
	public boolean updateEntity(CustomerManager t) throws Exception{
		super.update(t);
		return true;
	}
	 ...
	 * @return   是否删除成功
	 */
	public boolean deleteEntity(CustomerManager t) throws Exception{
		super.delete(t);
		return true;
	}
	 ...
	 * @throws Exception
	 */
	public CustomerManager findEntity(String property, Object value) throws Exception{
	 ...
	 * @throws Exception
	 */
	public CustomerManager findEntity(Map<String, Object> params) throws Exception{
